    ...
    <div>
      ...
      <div className="relative group">
        <textarea
          ...
          disabled={disabled}
          readOnly={readOnly}
          className={`w-full bg-slate-100 dark:bg-slate-900 border text-slate-900 dark:text-slate-200 rounded-md py-3 pl-4 pr-10 focus:ring-2 transition font-mono text-base sm:text-lg resize-y scrollbar-custom ${borderColor} ${ringColor} disabled:bg-slate-200 dark:disabled:bg-slate-800 disabled:cursor-not-allowed read-only:bg-slate-200 dark:read-only:bg-slate-800 read-only:cursor-default`}
        />
